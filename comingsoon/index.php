...
$(document).ready(function(){
	$('.button.green').click(function( ev )
	{
		ClixxieCSP.saveVote('YES', function( msg ){
			window.location.href = 'ty.html';
		});
	});
	$('.button.red').click(function( ev )
	{
		ClixxieCSP.saveVote('NO', function( msg ){
			window.location.href = 'ty.html';
		});
	});
});
...
<div id="container">
	...
	<div id="inputarea" class="full">
		...
		<div class="c50l">
			<div class="button green">Ja</div>
		</div>
		<div class="c50l">
			<div class="button red">Nein</div>
		</div>
	</div>
